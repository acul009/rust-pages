        ...
        div![
            ...
            PersonCard::new(
                ...
                div![
                    ...
                    p!(
                        "WÃƒÆ’Ã‚Â¤hrend meiner Laufbahn bekam ich den Einzug des Computers in alle Lebensbereiche hautnah mit. Nachdem immer mehr Freunde und Bekannte mit ihren Anliegen zu mir kamen, beschloss ich schließlich mein Hobby zum Beruf zu machen."
                    ),
                    p!(
                        "2004 machte ich mich schließlich selbststÃƒÆ’Ã‚Â¤ndig und eröffnete Rahn IT-Systemtechnik."
                    )
                ]
            ),
            PersonCard::new(
                ...
                div![
                    ...
                    p!(
                        "In meiner Jugend kam mein Interesse fÃƒÆ’Ã‚Â¼r Programmierung und die Funktionsweise moderner Computer auf. WÃƒÆ’Ã‚Â¤hrend meiner Ausbildung entdeckte ich Linux und die Open-Source Welt."
                    ),
                    p!(
                        "Inzwischen bin ich langjÃƒÆ’Ã‚Â¤hriger Linux-Nutzer und kÃƒÆ’Ã‚Â¼mmere mich im Betrieb um die Linux-Infrastruktur."
                    )
                ]
            )
        ]
