...
impl Page for About {
    ...
    fn view(data: &Self::Data) -> impl rust_pages::widget::ToElement<'_, Self> {
        div![
            ...
            ServiceCard::new("Pragmatische Arbeitsweise", &data.gears, div![
            ...
            ServiceCard::new("Ehrlichkeit und Transparenz", &data.transparency, div![
            ...
            ServiceCard::new("Verantwortungsvoller Cloud-Umgang", &data.cloud, div![
