...
use rust_pages::{div, h1, p, raw_html, page::Page, style::Style, theme::Theme};

use crate::components::site_data::{MAIL, PHONE, tel_href};
...
impl Page for Pricing {
    ...
    fn view(_: &Self::Data) -> impl rust_pages::widget::ToElement<'_, Self> {
        div![
            ...
            raw_html(r#"<div class="price-list"><div class="price-row"><div><strong>Anfahrt pro KM</strong></div><div class="amount">0,71 Ã¢â€šÂ¬</div></div><div class="price-row"><div><strong>Dienstleistung pro Stunde</strong><p>Bei einer Anfahrt <b>unter 25 km</b> werden mindestens 0,25 Stunden berechnet.</p><p>Bei einer Anfahrt <b>ab 25 km</b> werden mindestens 0,5 Stunden berechnet.</p></div><div class="amount">107,10 Ã¢â€šÂ¬</div></div></div>"#),
            p!("Unsere Preise fÃƒÂ¼r GerÃƒÂ¤te richten sich nach unseren aktuellen Einkaufspreisen."),
